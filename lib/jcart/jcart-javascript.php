...
// WHEN THE PAGE LOADS
function setupSubmit(theFrm)
{
	//alert('hi');
	// GET INPUT VALUES FOR USE IN AJAX POST
	var itemId = theFrm.find('input[name=<?php echo $jcart['item_id']?>]').val();
	var itemPrice = theFrm.find('input[name=<?php echo $jcart['item_price']?>]').val();
	var itemName = theFrm.find('input[name=<?php echo $jcart['item_name']?>]').val();
	var itemQty = theFrm.find('input[name=<?php echo $jcart['item_qty']?>]').val();
	var itemAdd = theFrm.find('input[name=<?php echo $jcart['item_add']?>]').val();
