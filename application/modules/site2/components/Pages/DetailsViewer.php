<?php
class Site_Pages_DetailsViewer
{
	public $view;
	public $catalogGuid;
	public $folderGuid;
	...
	public function __construct($catalogGuid, $folderGuid)
	{
		...
		$this->rowCatalog = $rowCatalog;
		
		$this->profileGuid = $rowCatalog->profileGuid;
		
		switch ($rowCatalog->profileGuid)
		{
			case 'article':
			case 'kutu_article':
				$this->viewArticle();
	...
	public function render()
	{
		...
		switch ($this->profileGuid)
		{
			case 'article':
			case 'kutu_article':
				$this->viewArticle();
				return $this->view->render("articleviewer.phtml");
				break;
			default:
				$this->view();
